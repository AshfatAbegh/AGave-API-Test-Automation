...
public class DB {
    ...
    public static Statement getConnection2() {
        String url = "jdbc:mysql://agave-db-test:3306/notification";
        String username = "agave_user";
        String password = "agave_pass";
    ...
    public static void truncateTables2(String[] tables) {
        Statement s = DB.getConnection2();
        try {
            s.addBatch("SET FOREIGN_KEY_CHECKS = 0");
            List.of(tables).forEach(t -> {
                try {
