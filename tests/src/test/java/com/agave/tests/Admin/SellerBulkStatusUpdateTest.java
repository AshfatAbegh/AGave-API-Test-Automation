...
public class SellerBulkStatusUpdateTest {
    ...
    @Test(priority = 1)
    public void adminShouldNotUpdateTheSellerBulkStatusWithInvalidId() throws SQLException {
        ...
        requestBody.put("sellerStatus", "SELLER_APPROVE");
        ...
        Response response = given()
                ...
                .body(requestBody)
                .when()
                .post(baseURI + "v1/admin/seller-bulk-accept");
    ...
    @Test(priority = 2)
    public void adminShouldUpdateTheSellerBulkStatusWhichIsInUnderReviewConditionWithValidId() throws SQLException {
        HashMap<String, Object> requestBody = new HashMap<>();
    ...
    @Test(priority = 3)
    public void adminShouldNotUpdateTheSellerBulkStatusWhichIsNotInUnderReviewCondition() throws SQLException {
        HashMap<String, Object> requestBody = new HashMap<>();
