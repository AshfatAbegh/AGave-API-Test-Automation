...
public class ProductBulkStatusUpdateTest {
        ...
        private static void insertProduct(int id, String acquisitionRouteDescription, long appliedAt,
                        ...
                        String treeSpecies,
                        long updatedAt, String width, int buyerId_id, int sellerId_id, String readaleId) throws SQLException {
                ...
                DB.getConnection().executeUpdate(
                                "INSERT INTO `products` (`id`, `acquisitionRouteDescription`, `appliedAt`, `breedingMethod`, `conditionAtTheTimeOfShipment`, `countryOfOrigin`, `createdAt`, `daysOfDelivery`, `deliveredAt`, `name`, `orderCreatedAt`, `orderId`, `price`, `publishedAt`, `purchasedAt`, `shippedAt`, `shippingBuildingName`, `shippingCity`, `shippingCost`, `shippingMethod`, `shippingOrigin`, `shippingPostalCode`, `shippingPrefecture`, `size`, `status`, `supplementaryInformation`, `treeSpecies`, `updatedAt`, `width`, `buyerId_id`, `sellerId_id`, `readableId`) VALUES ('"
                                                ...
                                                + "', '" + buyerId_id + "', '" + sellerId_id + "', '" + readaleId + "')");
        }
        ...
        @Test(priority = 1)
        public void adminShouldNotUpdateStatusOfTheBulkProductListWithInvalidId() throws SQLException {
                ...
                requestBody.put("productStatus", "PUBLISHED");
                ...
                Response response = given()
                                ...
                                .body(requestBody)
                                .when()
                                .post(baseURI + "v1/admin/product-bulk-accept");
        ...
        @SuppressWarnings("unchecked")
        @Test(priority = 2)
        public void adminShouldUpdateStatusOfTheBulkProductListWhichIsInUnderReviewConditionWithValidId() throws SQLException {
        ...
        @SuppressWarnings("unchecked")
        @Test(priority = 3)
        public void adminShouldNotUpdateStatusOfTheBulkProductListWhichIsNotInUnderReviewCondition() throws SQLException {
                ...
                String message = response.jsonPath().getString("message");
                Assert.assertEquals(message, "ステータスは「検討中」である必要があります");
        }
}
