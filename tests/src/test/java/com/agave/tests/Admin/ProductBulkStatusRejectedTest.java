...
public class ProductBulkStatusRejectedTest {
        ...
        @Test(priority = 1)
        public void adminShouldNotRejectTheStatusOfBulkProductListWithInvalidId() throws SQLException {
                ...
                requestBody.put("productStatus", "REJECTED");
                ...
                Response response = given()
                                ...
                                .body(requestBody)
                                .when()
                                .post(baseURI + "v1/admin/product-bulk-reject");
        ...
        @SuppressWarnings("unchecked")
        @Test(priority = 2)
        public void adminShouldRejectTheStatusOfTheBulkProductListWhichIsInUnderReviewConditionWithValidId() throws SQLException {
