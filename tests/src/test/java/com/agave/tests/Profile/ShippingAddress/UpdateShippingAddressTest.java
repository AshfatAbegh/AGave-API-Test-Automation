...
public class UpdateShippingAddressTest {
    ...
    @Test(priority = 1)
    public void userShouldUpdateProductShippingAddressWithProperInformation() {
        HashMap<String, Object> requestBody = new HashMap<>();
        requestBody.put("postalCode", "123456");
        requestBody.put("prefectures", "efgh");
        requestBody.put("cityStreetAddress", "Japan");
        requestBody.put("buildingNameAndRoomNumber", "40");
        ...
        Response response = given()
                ...
                .body(requestBody)
                .when()
                .post(baseURI + "v1/profile/update-shipping-address");

        Assert.assertEquals(response.getStatusCode(), 200);
    }

    @Test(priority = 2)
    public void userShouldNotUpdateProductShippingAddressWithoutAnyInformation() {
        Response response = given()
                .header("Authorization", "Bearer " + accessToken)
                .header("Accept-Language", "jp")
                .contentType(ContentType.JSON)
    ...
    @Test(priority = 3)
    public void userShouldNotUpdateProductShippingAddressWithoutAuthorization() {
        HashMap<String, Object> requestBody = new HashMap<>();
        requestBody.put("postalCode", "123456");
        requestBody.put("prefectures", "efgh");
        requestBody.put("cityStreetAddress", "Japan");
