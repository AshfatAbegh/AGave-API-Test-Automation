// package com.agave.tests.Profile.InfoAdd;                    //commented for whole system test purpose
...
//         insertSocialLinks(1, "https://identity.getpostman.com/browser-auth/success", "asif", "Instagram",
//                 "https://identity.getpostman.com/browser-auth/success", 1);
//     }
...
//             String userStatus, double balance, String accountStatus, String readableId, long activatedDateAt)
//             throws SQLException {
...
//                         + "', '" + surNameKanji + "', '" + updatedDateAtTimestamp + "', '" + userStatus + "', '"
//                         + balance + "', '" + accountStatus + "', '" + readableId + "', '" + activatedDateAtTimestamp
//                         + "')");
//     }

//     private void insertSocialLinks(int id, String link, String name, String platformName, String profilePictureUrl,
//             int profile_id) throws SQLException {
//         DB.getConnection().executeUpdate("INSERT INTO `social_links` (`id`, `link`, `name`, `platformName`, `profilePictureUrl`, `profile_id`) VALUES ('"
//                         + id + "', '" + link + "', '" + name + "', '" + platformName + "', '" + profilePictureUrl
//                         + "', '" + profile_id + "')");
//     }

//     @Test(priority = 1)
//     public void userShouldDeleteSNSForValidIdWithProperAuthorization() {

//         Response response = given()
//                 .header("Authorization", "Bearer " + accessToken)
//                 .header("Accept-Language", "jp")
//                 .when()
//                 .delete(baseURI + "v1/profile/social-link-delete/1");

//         Assert.assertEquals(response.getStatusCode(), 200);
//         response.then().assertThat().body(JsonSchemaValidator.matchesJsonSchemaInClasspath("SNSDeleteTestJSONSchema.json"));
//     }

//     @Test(priority = 2)
//     public void userShouldNotDeleteSNSForInValidId() {

//         Response response = given()
//                 .header("Authorization", "Bearer " + accessToken)
//                 .header("Accept-Language", "jp")
//                 .when()
//                 .delete(baseURI + "v1/profile/social-link-delete/4");

//         Assert.assertEquals(response.getStatusCode(), 404);
//         String message = response.jsonPath().getString("message");
//         Assert.assertEquals(message, "ソーシャルアカウントがありません");
//     }

//     @Test(priority = 3)
//     public void userShouldNotDeleteSNSForAnIdWithoutAuthorization() {
