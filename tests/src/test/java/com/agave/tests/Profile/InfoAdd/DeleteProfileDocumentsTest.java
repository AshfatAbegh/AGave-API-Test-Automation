...
// public class DeleteProfileDocumentsTest {
...
//                 "abc", "Hossain", "Islam", new Date().getTime(), "USER", 0, "ACTIVATE", "PL0000001", new Date().getTime());

//         accessToken = jwtToken.generateAccessToken(1, "asif1@gmail.com");

//         insertIdentificationDocument(1, "profile/documents/document_1716814275106.png", 1);
//     }
...
//                                        String shippingAddressBuildingNameAndRoomNumber,
//                                        String shippingAddressCityStreetAddress, int i, String shippingAddressPrefectures,
//                                        String surNameFurigana, String surNameKanji, long updatedDateAt,
...
//     private void insertIdentificationDocument(int id, String documentUrl, int profile_id) throws SQLException {
//         DB.getConnection().executeUpdate("INSERT INTO `identification_documents` (`id`, `documentUrl`, `profile_id`) VALUES ('"
//                 + id + "', '" + documentUrl + "', '" + profile_id + "')");
//     }

//     @Test(priority = 1)
//     public void userShouldDeleteProfileDocumentWithValidDocumentId() throws SQLException {
//         Response response = given()
//                 .header("Authorization", "Bearer " + accessToken)
//                 .header("Accept-Language", "jp")
//                 .when()
//                 .delete(baseURI + "v1/profile/delete-document/1");

//         Assert.assertEquals(response.getStatusCode(), 200);
//     }

//     @Test(priority = 2)
//     public void userShouldNotDeleteProfileDocumentWithInvalidDocumentId() {
//         Response response = given()
//                 .header("Authorization", "Bearer " + accessToken)
//                 .header("Accept-Language", "jp")
//                 .when()
//                 .delete(baseURI + "v1/profile/delete-document/1000");

//         Assert.assertEquals(response.getStatusCode(), 404);
//         String message = response.jsonPath().getString("message");
//         Assert.assertEquals(message, "ドキュメントが見つかりません");
//     }

//     @Test(priority = 3)
//     public void userShouldNotDeleteProfileDocumentWithoutAuthorization() {
//         Response response = given()
//                 .header("Accept-Language", "jp")
//                 .when()
//                 .delete(baseURI + "v1/profile/delete-document/1");
