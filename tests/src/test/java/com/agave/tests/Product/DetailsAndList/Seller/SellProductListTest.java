package com.agave.tests.Product.DetailsAndList.Seller;
...
public class SellProductListTest {
        ...
        @Test(priority = 1)
        public void sellerShouldGetProductListAccordingToStatus() {

                Response response = given()
                                .header("Authorization", "Bearer " + accessToken)
                                .queryParam("status", "PUBLISHED")
                                .when()
                                .get(baseURI + "v1/product/seller-sell-products");

                Assert.assertEquals(response.getStatusCode(), 200);
                response.then().assertThat().body(JsonSchemaValidator.matchesJsonSchemaInClasspath("SellProductListTestJSONSchema.json"));
        }

        @Test(priority = 2)
        public void sellerShouldGetProductListBySearchingProductName() {

                Response response = given()
                                .header("Authorization", "Bearer " + accessToken)
                                .queryParam("search", "Toy2")
                                .when()
                                .get(baseURI + "v1/product/seller-sell-products");
        ...
        @Test(priority = 3)
        public void sellerShouldGetProductListWithBothStatusAndName() {
        ...
        @Test(priority = 4)
        public void sellerShouldNotGetProductListWithoutAuthorization() {
