...
public class BuyerSurveyTest {
    ...
    @Test(priority = 1)
    public void buyerShouldConductSurveyOnThePurchasedProductWithValidId() {

        @SuppressWarnings("rawtypes")
        HashMap requestBody = new HashMap<>();
        requestBody.put("productId", 1);
        requestBody.put("sellerProductRating", 5);
        requestBody.put("sellerPackagingRating", 5);
        requestBody.put("sellerServiceRating", 5);
        requestBody.put("surveyTitle", "Buyer Survey");
        requestBody.put("surveyComment", "Good");
        requestBody.put("surveySuggestion", "Need Improvement in Packaging");
        ...
        Response response = given()
                ...
                .when()
                .post(baseURI + "v1/product/buyer-survey");
    ...
    @SuppressWarnings("unchecked")
    @Test(priority = 2)
    public void buyerShouldNotConductSurveyOnThePurchasedProductWithInvalidId() {
    ...
    @SuppressWarnings("unchecked")
    @Test(priority = 4)
    public void buyerShouldNotConductSurveyOnThePurchasedProductWithoutAuthorization() {
