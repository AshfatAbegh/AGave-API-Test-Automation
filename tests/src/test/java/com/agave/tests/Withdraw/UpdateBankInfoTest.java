...
public class UpdateBankInfoTest {
    ...
    public void dbSetUp() throws SQLException{
        ...
        insertTestBankInfo(1, "John Doe", "465464846848778", "City Bank", "80535", "Dhaka", new Date().getTime(), "OrdinaryDeposit", 1);
    }
    ...
    private static void insertTestBankInfo(int id, String accountName, String accountNumber, String bankName, String branchCode, String branchOffice, long createdDateAt, String deposit, int profile_id) throws SQLException{
        Timestamp createdDateAtTimestamp = new Timestamp(createdDateAt);
        DB.getConnection().executeUpdate("INSERT INTO `bank_informations` (`id`, `accountName`, `accountNumber`, `bankName`, `branchCode`, `branchOffice`, `createdDateAt`, `deposit`, `profile_id`) VALUES ('" + id + "', '" + accountName + "', '" + accountNumber + "', '" + bankName + "', '" + branchCode + "', '" + branchOffice + "', '" + createdDateAtTimestamp + "', '" + deposit + "', '" + profile_id + "')");
    }

    @SuppressWarnings("unchecked")
    @Test(priority = 1)
    public void userShouldUpdateBankInfoByFillingAllTheFieldsWithProperAuthorization(){

        @SuppressWarnings("rawtypes")
        HashMap requestBody = new HashMap();
        requestBody.put("id", 1);
        requestBody.put("bankName","Jamuna Bank");
        ...
        Response response = given()
                 ...
                 .body(requestBody)
                 .when()
                 .put(baseURI + "v1/withdraw/update-bank-info");
    ...
    public void branchCodeNumberShouldNotBeGreaterThanTenNumber(){
        ...
        Assert.assertEquals(message, "支店コードには最大 10 個の数字が含まれます");
    }
    ...
    public void accountNumberShouldNotBeGreaterThanTwentyNumbers(){
        ...
        Assert.assertEquals(response.getStatusCode(), 406);
        String message = response.jsonPath().getString("message");
        Assert.assertEquals(message, "支店コードには最大 20 個の数字が含まれます");
    }  
    
    @SuppressWarnings("unchecked")
    @Test(priority = 4)
    public void userShouldNotUpdateBankInfoWithoutAuthorization(){
        ...
        Response response = given()
                 ...
                 .body(requestBody)
                 .when()
                 .put(baseURI + "v1/withdraw/add-bank-info");
